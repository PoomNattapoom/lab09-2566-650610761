export const Task = ({
  ...
  const doneBtnOnClick = () => {
    toggleDoneTaskFunc(id, completed);
  };

  const taskClassname = completed ? "text-decoration-line-through" : "";
  ...
  return (
    <div className="d-flex p-3 gap-2 align-items-center border-bottom">
      ...
      But if task is not completed :<span>{title}</span> */}
      <span className={taskClassname}>{title}</span>
